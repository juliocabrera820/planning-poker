defmodule PlanningPoker.PromEx do
  @moduledoc """
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: PlanningPokerWeb.Router, endpoint: PlanningPokerWeb.Endpoint},
      Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      # {:planning_poker, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
